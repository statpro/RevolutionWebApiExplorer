...
namespace StatPro.Revolution.WebApiExplorerTests.ControllerTests
{
    ...
    public class WebApiControllerTests : BaseControllerTests
    {
        ...
        [TestCase("application/vnd.statpro.revolution.api.eula", "eula")]
        [TestCase("application/vnd.statpro.revolution.api.eula+xml", "eula")]
        [TestCase("application/vnd.statpro.revolution.api.eula+json", "eula")]
