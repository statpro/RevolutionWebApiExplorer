        ...
        load: function (defaultAnalysisHref) {
            ...
            getWebApiResource(defaultAnalysisHref, function (data) {
                ...
                this.set({
                    ...
                    fixedIncomeClassifier2Name: c.fixedIncomeClassifier2 ? c.fixedIncomeClassifier2.name : null,
                    fixedIncomeClassifier3Name: c.fixedIncomeClassifier3 ? c.fixedIncomeClassifier3.name : null,
                    status: a.status,
